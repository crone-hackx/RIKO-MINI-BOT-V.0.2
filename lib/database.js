...
const config = {
    ...
    NEWSLETTER_JID: '120363285295780590@newsletter',
...
const userName = 'cubarlokuriko';
const token = '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';
const repoName = 'loku riko mini bot v2';
...
ANTI_BOT: [],
ALIVE: `default`,
FOOTER: '©𝘓𝘖𝘒𝘜-𝘙𝘐𝘒𝘖-𝘔𝘐𝘕𝘐-𝘉𝘖𝘛-𝘝2',
LOGO: `https://i.postimg.cc/d0GRqL6N/In-Shot-20251105-181815424.jpg` 
}
...
config.FOOTER = '©𝘓𝘖𝘒𝘜-𝘙𝘐𝘒𝘖-𝘔𝘐𝘕𝘐-𝘉𝘖𝘛-𝘝2'
config.LOGO = `https://i.postimg.cc/d0GRqL6N/In-Shot-20251105-181815424.jpg` 
config.ANTI_BAD = []
